...
import { ThreeDanimationData } from "../../data/3D-animationData";
import SubjectPrinciples from "../../pages/SubjectPrinciples";
import ProjectList from "../../pages/ProjectList";

function ThreeDanimation() {
  const { animation3D } = ThreeDanimationData;
  const arrayOfPrinciples = animation3D.principles;
  const arrOfProjects = animation3D.projects;
